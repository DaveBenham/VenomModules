...
struct MixFade2Widget : MixExpanderWidget {
  ...
  MixFade2Widget(MixFade2* module) {
    ...
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(10.73f,  47.045f), module, MixModule::RISE_TIME_PARAM+0));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(10.73f,  77.785f), module, MixModule::RISE_TIME_PARAM+1));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(10.73f, 108.525f), module, MixModule::RISE_TIME_PARAM+2));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(10.73f, 139.264f), module, MixModule::RISE_TIME_PARAM+3));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(10.73f, 173.004f), module, MixModule::MIX_RISE_TIME_PARAM));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(49.27,   47.045f), module, MixModule::FALL_TIME_PARAM+0));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(49.27,   77.785f), module, MixModule::FALL_TIME_PARAM+1));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(49.27,  108.525f), module, MixModule::FALL_TIME_PARAM+2));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(49.27,  139.264f), module, MixModule::FALL_TIME_PARAM+3));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(49.27,  173.004f), module, MixModule::MIX_FALL_TIME_PARAM));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(30.f,    37.545f), module, MixModule::FADE2_SHAPE_PARAM+0));
    addParam(createLockableParamCentered<TrimpotLockable>(Vec(30.f,    68.285f), module, MixModule::FADE2_SHAPE_PARAM+1));
