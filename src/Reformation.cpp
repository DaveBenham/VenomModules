...
struct ReformationWidget : VenomWidget {
  ...
  ReformationWidget(Reformation* module) {
    ...
    for (int i=0; i<MAP_COUNT; i++, x+=30.f){
      ...
      addInput(createInputCentered<PJ301MPort>(Vec(x,224.5f), module, Reformation::CV1_INPUT+i));
      addParam(createLockableParamCentered<RoundSmallBlackKnobLockable>(Vec(x, 257.f), module, Reformation::CV2_PARAM+i));
      addInput(createInputCentered<PJ301MPort>(Vec(x,289.5f), module, Reformation::CV2_INPUT+i));
    }
    addInput(createInputCentered<PJ301MPort>(Vec(33.f,340.5f), module, Reformation::IN_INPUT));
    addInput(createInputCentered<PJ301MPort>(Vec(66.f,340.5f), module, Reformation::DRIVE_INPUT));
    addInput(createInputCentered<PJ301MPort>(Vec(99.f,340.5f), module, Reformation::LEVEL_INPUT));
    addOutput(createOutputCentered<PJ301MPort>(Vec(132.f,340.5f), module, Reformation::OUT_OUTPUT));
  }
